...
import { Menu, X, MapPin, Mail, ArrowRight, Globe, Shield, Database } from 'lucide-react';
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl px-6 md:px-12 w-full mt-20 animate-fade-in-up flex flex-col md:items-start items-center text-center md:text-left">
        <div className="inline-block px-4 py-1.5 mb-8 border border-white/30 rounded-full bg-white/5 backdrop-blur-sm">
          <span className="text-white text-xs tracking-[0.2em] uppercase font-bold">Strategic Consultancy</span>
        </div>
        ...
        <p className="font-body text-lg md:text-xl text-gray-200 max-w-2xl mb-12 leading-relaxed font-light">
          Eikon Partners acts as the strategic nexus between high-growth technology ventures and Asia's most prestigious institutions.
        </p>
...
const WhatWeDo = () => {
  const services = [
    { icon: <Shield size={32} />, title: "Cybersecurity & Defense", desc: "Implementing institutional-grade security protocols for sovereigns and major banks." },
    { icon: <Database size={32} />, title: "Web3 Infrastructure", desc: "Connecting decentralized networks with traditional financial rails safely and compliantly." },
    { icon: <Globe size={32} />, title: "Market Entry", desc: "Navigating regulatory frameworks in Singapore, Hong Kong, and Tokyo for western tech firms." },
  ];
    ...
    <div className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h3 className="font-header text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              The Architecture of <br/>Modern Trust
            </h3>
          </div>
          <div>
            <p className="font-body text-gray-600 text-lg leading-relaxed">
              We don't just advise; we engineer connections. Eikon Partners identifies breakthrough technologies in cybersecurity and blockchain infrastructure and operationalizes them for Asia's largest financial and governmental institutions. We bridge the gap between "move fast" and "scale securely."
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((s, i) => (
            <div key={i} className="p-8 border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-sm group">
              ...
              <h4 className="font-header font-bold text-xl text-gray-900 mb-3">{s.title}</h4>
        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="font-body text-gray-600 text-lg leading-relaxed">
                Whether you are a startup looking to penetrate the Asian market, or an institution seeking cutting-edge technological integration, Eikon Partners is ready to facilitate.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-body text-gray-500">Marina Bay Financial Centre<br/>Tower 2, Level 39<br/>Singapore 018983</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-body text-gray-500">partnerships@eikonpartners.asia</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="font-body text-gray-400 text-sm leading-relaxed max-w-xs">
              Bridging Bold Tech to Asia. We connect institutional capital and government infrastructure with the next generation of technological capability.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 font-body text-gray-400 text-sm">
              ...
              <li><button onClick={() => setActivePage('team')} className="hover:text-white transition-colors">The Team</button></li>
